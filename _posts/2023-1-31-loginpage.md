...
<script>
    ...
    function login_api(uid, pw){
      ...
      fetch("http://127.0.0.1:8045/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
  ...
  <form action="javascript:login_user()">
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='https://aidandelgado2.github.io/student2//2024/01/22/Signup_page_demographics.html'" class="button-spacing" >Sign Up</button>
